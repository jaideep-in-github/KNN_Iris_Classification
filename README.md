...
- ⚖️ Normalizing features is non-negotiable. I tried skipping it once, and my accuracies were a mess.
...
### ✅ Conclusion
This IrisKNNClassifier project was an incredible learning experience for me! I successfully built a KNN classifier on the Iris dataset, achieving 100% accuracy across different K values and metrics, and created insightful visualizations like decision boundaries and box plots to understand the data better. Through this task, I learned the importance of feature selection, normalization, and the power of KNN in clean datasets—it felt like unlocking a new level in my ML journey! I’m super excited to continue exploring machine learning, and I hope to bring this curiosity and energy to Elevale’s internship to tackle even bigger challenges in AI.